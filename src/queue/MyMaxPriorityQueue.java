...
public class MyMaxPriorityQueue<E> {
    ...
    private void percolateDown() {
        ...
        while (childIndex <= this.size && lastedKeyAsDecimal.compareTo(childKeyAsDecimal) < 0) {
            // Swap the largest child key with parent key
            this.elements[parentIndex] = childKey;
    ...
    public static void main(String[] args) {
        MyMaxPriorityQueue<Integer> priorityQueue = new MyMaxPriorityQueue<>();
